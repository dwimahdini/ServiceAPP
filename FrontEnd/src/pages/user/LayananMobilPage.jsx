          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="max-w-2xl">
              ...
              <p className="text-xl mb-8 text-gray-200">
                Kami menyediakan layanan perbaikan dan perawatan mobil terbaik dengan teknisi berpengalaman dan peralatan modern untuk semua jenis mobil.
              </p>
            </div>
          </div>
        </div>
...
export default LayananMobilPage;
